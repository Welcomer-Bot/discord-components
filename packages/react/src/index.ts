import * as ReactComponents from '@welcomer-bot/discord-components-core';
...
export type { Avatars, DiscordMessageOptions, DiscordTimestamp, Emoji, LightTheme, Profile } from '@welcomer-bot/discord-components-core';
export { getConfig, setConfig } from '@welcomer-bot/discord-components-core';
